                    ...
                    @foreach ($order->items as $item)
                        <tr>
                            ...
                            <td class="text-end"><strong>{{ number_format($item->total, 2) }}
                                    {{ setting('currency', 'KWD') }}</strong></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
                    ...
                    <tbody>
                        @foreach($order->vendorOrders as $vendorOrder)
                            <tr>
                                ...
                                <td class="text-end">{{ number_format($vendorOrder->sub_total, 2) }} {{ setting('currency', 'KWD') }}</td>
                                <td class="text-end">{{ number_format($vendorOrder->shipping_cost, 2) }} {{ setting('currency', 'KWD') }}</td>
