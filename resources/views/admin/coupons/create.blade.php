    ...
    <div class="container-fluid p-4 p-lg-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <h1 class="h3 mb-0">{{ __('Create Coupon') }}</h1>
                <p class="text-muted mb-0">{{ __('Add a new discount coupon') }}</p>
            </div>
            <div>
                        ...
                        <form action="{{ route('admin.coupons.store') }}" method="POST" id="couponForm">
                            ...
                            <div class="mb-4">
                                ...
                                @error('discount_value')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text" id="discountHelp">{{ __('Enter the percentage discount (e.g., 10 for 10%)') }}</div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <input type="number"
                                           ...
                                           step="0.01"
                                           min="0">
                                    <span class="input-group-text">{{ setting('currency', 'KWD') }}</span>
                                </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-circle me-2"></i>{{ __('Create Coupon') }}
                                </button>
                            </div>
                        </form>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        typeSelect.addEventListener('change', function() {
            if (this.value === 'percentage') {
                ...
                discountUnit.textContent = '{{ setting('currency', 'KWD') }}';
