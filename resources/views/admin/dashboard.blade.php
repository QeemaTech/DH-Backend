                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="h4 mb-0 fw-bold">{{ number_format($yearRevenue, 2) }} {{ setting('currency', 'KWD') }}</div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="h5 mb-0 fw-semibold">{{ number_format($monthRevenue, 2) }} {{ setting('currency', 'KWD') }}</div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6">
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="text-muted small mb-1">{{ __('LikeCard Balance') }}</div>
                            @if(!empty($like4appBalanceError))
                                <div class="h5 mb-0 fw-semibold text-danger">{{ __('Unavailable') }}</div>
                                <small class="text-muted">{{ __('Check Like4App credentials') }}</small>
                            @else
                                <div class="h5 mb-0 fw-semibold">
                                    {{ is_null($like4appBalance) ? '—' : $like4appBalance }}
                                    {{ $like4appCurrency ?: '—' }}
                                </div>
                                <small class="text-muted">{{ __('Cached for 5 minutes') }}</small>
                            @endif
                        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6">
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="text-muted small mb-1">{{ __('EezeePay Balance') }}</div>
                            @if(!empty($eezeePayBalanceError))
                                <div class="h5 mb-0 fw-semibold text-danger">{{ __('Unavailable') }}</div>
                                <small class="text-muted">{{ __('Check EezeePay credentials') }}</small>
                            @else
                                <div class="h5 mb-0 fw-semibold">
                                    {{ is_null($eezeePayBalance) ? '—' : $eezeePayBalance }}
                                    {{ $eezeePayCurrency ?: '—' }}
                                </div>
                                <small class="text-muted">{{ __('Cached for 5 minutes') }}</small>
                            @endif
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="h5 mb-0 fw-semibold">{{ number_format($yearCommission, 2) }} {{ setting('currency', 'KWD') }}</div>
                            <small class="text-muted">{{ __('This Year') }}</small>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="h5 mb-0 fw-semibold">{{ number_format($todayRevenue, 2) }} {{ setting('currency', 'KWD') }}</div>
                                ...
                                <tbody>
                                    @foreach($recentOrders as $order)
                                        <tr>
                                            ...
                                            <td>
                                                <strong>{{ number_format($order->total, 2) }} {{ setting('currency', 'KWD') }}</strong>
                                            </td>
                                            <td>
                                    ...
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted d-block">
                                                {{ number_format($item['total_sales'], 2) }} {{ setting('currency', 'KWD') }}
