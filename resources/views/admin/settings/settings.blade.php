            ...
            <form id="settings-form" action="{{ route('admin.settings.update') }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 settings-content">
                        ...
                        <hr class="my-4">
                        <h5 class="mb-3">{{ __('Contact & Social') }}</h5>

                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="contact_whatsapp" class="form-label">{{ __('WhatsApp') }}</label>
                            ...
                            <div class="col-md-6">
                                <label for="contact_facebook" class="form-label">{{ __('Facebook') }}</label>
                                <input type="text" class="form-control" id="contact_facebook" name="contact_facebook"
                                    value="{{ setting('contact_facebook', '') }}">
                            </div>
                            <div class="col-md-6">
                                <label for="contact_instagram" class="form-label">{{ __('Instagram') }}</label>
                                <input type="text" class="form-control" id="contact_instagram" name="contact_instagram"
                                    value="{{ setting('contact_instagram', '') }}">
                            </div>

                            <div class="col-md-6">
                                <label for="contact_x" class="form-label">{{ __('X') }}</label>
                                <input type="text" class="form-control" id="contact_x" name="contact_x"
                                    value="{{ setting('contact_x', '') }}">
                            </div>
                            <div class="col-md-6">
                                <label for="contact_linkedin" class="form-label">{{ __('LinkedIn') }}</label>
                                <input type="text" class="form-control" id="contact_linkedin" name="contact_linkedin"
                                    value="{{ setting('contact_linkedin', '') }}">
                            </div>
                        </div>
                    </div>
                </div>
