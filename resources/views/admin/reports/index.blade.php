                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ number_format($report['kpis']['paid_orders_total'], 2) }} {{ setting('currency', 'KWD') }}
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ number_format($report['kpis']['total_commission'], 2) }} {{ setting('currency', 'KWD') }}
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <small class="text-muted">
                                {{ number_format($report['kpis']['refunded_total'], 2) }} {{ setting('currency', 'KWD') }}
                            </small>
                        </div>
