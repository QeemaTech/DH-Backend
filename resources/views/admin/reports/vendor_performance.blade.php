...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">{{ __('Gross, commission, net earnings and withdrawals for vendors') }}</p>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">{{ number_format($k['gross_sales'] ?? 0, 2) }} {{ setting('currency', 'KWD') }}</div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">{{ number_format($k['commission'] ?? 0, 2) }} {{ setting('currency', 'KWD') }}</div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">{{ number_format($k['net_earnings'] ?? 0, 2) }} {{ setting('currency', 'KWD') }}</div>
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <small class="text-muted">
                                {{ number_format($k['pending_withdrawals_total'] ?? 0, 2) }} {{ setting('currency', 'KWD') }}
                            </small>
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ number_format($k['approved_withdrawals_total'] ?? 0, 2) }} {{ setting('currency', 'KWD') }}
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ $k['current_balance'] !== null ? number_format($k['current_balance'], 2) : '—' }} {{ setting('currency', 'KWD') }}
                            </div>
                        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    @forelse($report['daily_sales'] as $row)
                        <tr>
                            <td>{{ $row['date'] }}</td>
                            <td class="text-end">{{ number_format($row['total'], 2) }} {{ setting('currency', 'KWD') }}</td>
                        </tr>
                    @empty
                        <tr>
    ...
    @push('modals')
        <div class="offcanvas offcanvas-end" tabindex="-1" id="filterOffcanvas" aria-labelledby="filterOffcanvasLabel">
            ...
            <div class="offcanvas-body">
                <form method="GET" action="{{ route('admin.reports.vendor-performance') }}" id="filterForm">
                    <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('admin.reports.vendor-performance') }}" class="btn btn-outline-secondary flex-fill">
