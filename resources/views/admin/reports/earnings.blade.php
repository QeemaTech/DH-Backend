                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ number_format($paidTotal, 2) }} {{ setting('currency', 'KWD') }}
                            </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ number_format($platformEarnings, 2) }} {{ setting('currency', 'KWD') }}
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ number_format($netRevenue, 2) }} {{ setting('currency', 'KWD') }}
                            </div>
                            <small class="text-muted">
                                {{ __('Refunded total') }}:
                                {{ number_format($refundedTotal, 2) }} {{ setting('currency', 'KWD') }}
                            </small>
                        </div>
