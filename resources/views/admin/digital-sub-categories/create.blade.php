...
@section('title', 'Create Digital Sub Category')
...
@section('content')
    <div class="container-fluid p-4 p-lg-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0">{{ __('Create Digital Sub Category') }}</h1>
                <p class="text-muted mb-0">{{ __('Add a new digital sub category') }}</p>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.digital-sub-categories.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select name="digital_category_id" class="form-select @error('digital_category_id') is-invalid @enderror" required>
                            ...
                            @foreach($digitalCategories as $digitalCategory)
                                <option value="{{ $digitalCategory->id }}" {{ old('digital_category_id') == $digitalCategory->id ? 'selected' : '' }}>
