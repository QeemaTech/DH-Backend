    ...
    <div class="body">
        ...
        <div class="withdrawal-meta">
            ...
            <div>
                ...
                <span class="amount">{{ number_format($withdrawal->amount, 2) }} {{ setting('currency', 'KWD') }}</span>
            </div>
            ...
            @if($withdrawal->balance_after !== null)
                <div><strong>{{ __('Current Balance') }}:</strong> {{ number_format($withdrawal->balance_after, 2) }} {{ setting('currency', 'KWD') }}</div>
            @endif
        </div>
