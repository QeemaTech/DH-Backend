                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="h4 mb-0 fw-bold">{{ number_format($vendor->balance ?? 0, 2) }} {{ setting('currency', 'KWD') }}</div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="h4 mb-0 fw-bold">{{ number_format($monthRevenue, 2) }} {{ setting('currency', 'KWD') }}</div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="h4 mb-0 fw-bold">{{ number_format($monthNetEarnings, 2) }} {{ setting('currency', 'KWD') }}</div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="h5 mb-0 fw-semibold">{{ number_format($monthCommission, 2) }} {{ setting('currency', 'KWD') }}</div>
                            <small class="text-muted">{{ __('This Month') }}</small>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="h5 mb-0 fw-semibold">{{ number_format($yearRevenue, 2) }} {{ setting('currency', 'KWD') }}</div>
                    ...
                    <div class="mt-2">
                        ...
                        @if($pendingWithdrawals > 0)
                            <a href="{{ route('vendor.withdrawals.index') }}" class="badge bg-warning text-dark me-2">
                                ...
                                ({{ number_format($pendingWithdrawalsTotal, 2) }} {{ setting('currency', 'KWD') }})
                            </a>
                        @endif
                    </div>
                </div>
                                ...
                                <tbody>
                                    @foreach($recentOrders as $vendorOrder)
                                        <tr>
                                            ...
                                            <td>
                                                <strong>{{ number_format($vendorOrder->total, 2) }} {{ setting('currency', 'KWD') }}</strong>
                                            </td>
                                            <td>
                                    ...
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted d-block">
                                                {{ number_format($product['revenue'], 2) }} {{ setting('currency', 'KWD') }}
