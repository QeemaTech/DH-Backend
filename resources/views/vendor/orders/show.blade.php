                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <dl class="row mb-0">
                            ...
                            <dd class="col-sm-9 mt-3">{{ number_format($vendorOrder->subtotal, 2) }} {{ setting('currency', 'KWD') }}</dd>

                            @if($vendorOrder->discount > 0)
                                <dt class="col-sm-3 mt-3">{{ __('Discount') }}</dt>
                                <dd class="col-sm-9 mt-3">
                                    <span class="text-danger">-{{ number_format($vendorOrder->discount, 2) }} {{ setting('currency', 'KWD') }}</span>
                                </dd>
                            @endif

                            <dt class="col-sm-3 mt-3">{{ __('Shipping Cost') }}</dt>
                            <dd class="col-sm-9 mt-3">{{ number_format($vendorOrder->shipping_cost, 2) }} {{ setting('currency', 'KWD') }}</dd>

                            @if($vendorOrder->commission > 0)
                                <dt class="col-sm-3 mt-3">{{ __('Commission') }}</dt>
                                <dd class="col-sm-9 mt-3">
                                    <span class="badge bg-success">{{ number_format($vendorOrder->commission, 2) }} {{ setting('currency', 'KWD') }}</span>
                                </dd>
                            @endif
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tfoot class="table-light">
                                        <tr>
                                            ...
                                            <td class="text-end"><strong>{{ number_format($vendorOrder->total, 2) }} {{ setting('currency', 'KWD') }}</strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <dl class="mb-0">
                            ...
                            <dd><strong>{{ number_format($vendorOrder->total, 2) }} {{ setting('currency', 'KWD') }}</strong></dd>
