                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ number_format($report['kpis']['gross_sales'], 2) }} {{ setting('currency', 'KWD') }}
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ number_format($report['kpis']['commission'], 2) }} {{ setting('currency', 'KWD') }}
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ number_format($report['kpis']['net_earnings'], 2) }} {{ setting('currency', 'KWD') }}
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ number_format($report['kpis']['current_balance'], 2) }} {{ setting('currency', 'KWD') }}
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <small class="text-muted">
                                {{ number_format($report['kpis']['pending_withdrawals_total'], 2) }} {{ setting('currency', 'KWD') }}
                            </small>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ number_format($report['kpis']['approved_withdrawals_total'], 2) }} {{ setting('currency', 'KWD') }}
                            </div>
                        </div>
