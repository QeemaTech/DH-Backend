                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ number_format($report['kpis']['current_balance'] ?? 0, 2) }} {{ setting('currency', 'KWD') }}
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ number_format($report['kpis']['net_earnings'] ?? 0, 2) }} {{ setting('currency', 'KWD') }}
                            </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">
                                {{ number_format($report['kpis']['approved_withdrawals_total'] ?? 0, 2) }} {{ setting('currency', 'KWD') }}
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <small class="text-muted">
                                {{ number_format($report['kpis']['pending_withdrawals_total'] ?? 0, 2) }} {{ setting('currency', 'KWD') }}
                            </small>
                        </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    @forelse($report['daily_sales'] as $row)
                        <tr>
                            <td>{{ $row['date'] }}</td>
                            <td class="text-end">
                                {{ number_format($row['total'], 2) }} {{ setting('currency', 'KWD') }}
                            </td>
                        </tr>
                    @empty
                        <tr>
