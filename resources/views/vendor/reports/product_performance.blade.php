...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">{{ __('Your product revenue, quantity, and net after commission') }}</p>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">{{ number_format($k['revenue'] ?? 0, 2) }} {{ setting('currency', 'KWD') }}</div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">{{ number_format($k['net'] ?? 0, 2) }} {{ setting('currency', 'KWD') }}</div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="fs-4 fw-semibold">{{ number_format($k['refunded_amount'] ?? 0, 2) }} {{ setting('currency', 'KWD') }}</div>
    ...
    @push('modals')
        <div class="offcanvas offcanvas-end" tabindex="-1" id="filterOffcanvas" aria-labelledby="filterOffcanvasLabel">
            ...
            <div class="offcanvas-body">
                <form method="GET" action="{{ route('vendor.reports.product-performance') }}" id="filterForm">
                    <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('vendor.reports.product-performance') }}" class="btn btn-outline-secondary flex-fill">
