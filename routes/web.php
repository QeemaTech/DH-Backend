...
use App\Http\Controllers\TabbyRedirectController;
...
Route::group(['middleware' => 'locale'], function () {
    ...
    Route::get('/send-sms', [HomeController::class, 'sendSms'])->name('send-sms');

    Route::post('sadad/webhook', [\App\Http\Controllers\PaymentController::class, 'SadadWebhook']);
    Route::any('tabby/webhook', [\App\Http\Controllers\PaymentController::class, 'TabbyWebhook']);
    Route::any('dema/webhook', [\App\Http\Controllers\PaymentController::class, 'DemaWebhook']);

    Route::get('tabby/success', [TabbyRedirectController::class, 'success'])->name('tabby.success');
    Route::get('tabby/cancel', [TabbyRedirectController::class, 'cancel'])->name('tabby.cancel');
    Route::get('tabby/failure', [TabbyRedirectController::class, 'failure'])->name('tabby.failure');

    Route::get('dema/success', [DemaRedirectController::class, 'success'])->name('dema.success');
    Route::get('dema/cancel', [DemaRedirectController::class, 'cancel'])->name('dema.cancel');
    Route::get('dema/failure', [DemaRedirectController::class, 'failure'])->name('dema.failure');
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => 'role:admin'], function () {
            ...
            // Digital Categories Routes
            Route::resource('digital-categories', DigitalCategoryController::class);
            ...
            Route::post('products/{product}/sync', [\App\Http\Controllers\Admin\ProductController::class, 'syncProduct'])->name('products.sync');
            Route::post('products/sync-stock-all', [\App\Http\Controllers\Admin\ProductController::class, 'syncAllProductsStock'])->name('products.sync-stock-all');
