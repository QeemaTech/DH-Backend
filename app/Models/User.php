...
class User extends Authenticatable
{
    ...
    protected function nationalCartFrontImage(): Attribute
    {
        return Attribute::make(
    ...
    protected function nationalCartBackImage(): Attribute
    {
        return Attribute::make(
            get: fn ($value) => $value ? asset('storage/'.$value) : null
        );
    ...
    /**
     * Send the email verification notification (custom flow; user does not implement MustVerifyEmail to avoid duplicate sends on Registered).
     */
